...
export const DOCKER_CLI_TIMEOUT = 15000;
 ...
 */
export async function doesStackExistInSwarm(stackName) {
 ...
 */
export async function retrieveStackList() {
  let stackList = [];
 ...
 */
export async function getServicesByStack(stackName) {
...
/**
   ...
   * @throws {Object} Any errors returned from the Docker API
   */
export async function inspectNetworkAxios(networkID) {
  try {
...
/**
   ...
   * @throws {Object} Any errors returned from the Docker API
   */
export async function inspectVolumeAxios(volumeID) {
  try {
 ...
 */
export async function dockerCLIDeployStack(stackName, stackFileBase64) {
...
/**
   ...
   * @throws {Object} Any errors returned from the Docker API
   */
export async function inspectServiceAxios(serviceID) {
  try {
...
/**
   ...
   * @throws {Object} Any errors returned from the Docker API
   */
export async function inspectTaskAxios(taskID) {
  try {
...
/**
   ...
   */
export async function getServiceIDsByStack(stackName) {
